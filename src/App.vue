...
<script lang="ts">
import { defineComponent, reactive, watch, toRefs, ref, } from '@vue/runtime-core'
...
export default defineComponent({
  ...
  setup() {
    ...
    store.dispatch('user/asyncVerifyLogin')
    ...
    watch(() => route.path, () => {
      isShow.showAside = route.meta.showAside === undefined ? true : route.meta.showAside as boolean
      isShow.showHeader = route.meta.showHeader === undefined ? true : route.meta.showHeader as boolean
      isShow.showFooter = route.meta.showFooter === undefined ? true : route.meta.showFooter as boolean
      isShow.showTabNav = route.meta.showTabNav === undefined ? true : route.meta.showTabNav as boolean
    })
